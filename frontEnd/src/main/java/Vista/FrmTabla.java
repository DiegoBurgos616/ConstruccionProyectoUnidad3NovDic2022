...
public class FrmTabla extends javax.swing.JFrame {
    ...
    public FrmTabla() {
        ...
        model.addRow(new Object[]{"1","Diego","Burgos","img/DiegoBurgos"});
        model.addRow(new Object[]{"2","Paola","Novelo","img.com/PaolaNovelo"});
        model.addRow(new Object[]{"3","Juan","Garcilazo","img.com/JuanGarcilazo"});
